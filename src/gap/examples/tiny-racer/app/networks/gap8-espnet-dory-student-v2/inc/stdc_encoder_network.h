...
static int weights_checksum[11] = {21, 149, 61, 230, 149, 188, 202, 0, 249, 124, 0};
...
static int out_mult_vector[11] = {1, 1, 1, 1, 1, 1, 1, 50, 1, 1, 56};
static int out_shift_vector[11] = {24, 22, 23, 23, 23, 22, 23, 6, 23, 23, 6};
