...
static const char * L3_weights_files[] = {
  "stdc_gate_head_BNReluConvolution0_weights.hex", "stdc_gate_head_BNReluConvolution1_weights.hex", "stdc_gate_head_BNReluConvolution2_weights.hex"
};
static int L3_weights_size[3];
static int layers_pointers[3];
static char * Layers_name[3] = {"stdc_gate_head_BNReluConvolution0", "stdc_gate_head_BNReluConvolution1", "stdc_gate_head_BNReluConvolution2"};
...
static int weights_checksum[3] = {202, 224, 5};
static int weights_size[3] = {800, 768, 32};
...
static int activations_size[3] = {51200, 51200, 25600};
static int out_mult_vector[3] = {1, 1, 1};
static int out_shift_vector[3] = {22, 16, 24};
...
static int activations_out_size[3] = {51200, 25600, 1600};
