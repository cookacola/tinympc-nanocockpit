...
void stdc_corner_head_BNReluConvolution3(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.loc = (uint32_t) l1_buffer + 8088;
        ...
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 8128;
    ...
    k = (int64_t *) (l1_buffer + 8088);
    lambda = (int64_t *) (l1_buffer + 8128);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 20, 20, 4, 20, 4, 0, 0, 0, 0, 0, 0, 8);
