...
void stdc_encoder_BNReluConvolution19(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      x_tile_size_nif = (_i_nif_load+1 == 2) ? 32 : 32;
      ...
      x_length_nif_byte = (_i_nif_load+1 == 2)   ? 32 : 32;
      ...
      y_tile_size_nof = (_i_nof_load+1 == 2) ? 32 : 32;
      y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*8/8;
      y_length_nof_byte = (_i_nof_load+1 == 2)   ? 32 : 32;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 20, 20, 32, 20, 64,  2, 2,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.loc = (uint32_t) l1_buffer + 25912;
        DMA_copy_k.length_1d_copy = (uint16_t) W_tile_size_nof * 8;
        dory_dma_memcpy_async(&DMA_copy_k);
        dory_dma_barrier(&DMA_copy_k);

        DMA_copy_lambda.ext = (uint32_t) l2_W+1088 + 256*_i_nof_load;
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 26176;
    ...
    k = (int64_t *) (l1_buffer + 25912);
    lambda = (int64_t *) (l1_buffer + 26176);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 20, 20, 32, 20, 64, 0, 0, 0, 0, 0, 0, 8);
