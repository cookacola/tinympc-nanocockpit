...
void stdc_navigation_head_BNReluConvolution12(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.loc = (uint32_t) l1_buffer + 28440;
        ...
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 29216;
    ...
    k = (int64_t *) (l1_buffer + 28440);
    lambda = (int64_t *) (l1_buffer + 29216);
