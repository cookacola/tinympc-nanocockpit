...
void stdc_gate_head_BNReluConvolution3(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 20, 20, 16, 20, 16,  0, 0,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.loc = (uint32_t) l1_buffer + 6840;
        ...
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 6856;
    ...
    k = (int64_t *) (l1_buffer + 6840);
    lambda = (int64_t *) (l1_buffer + 6856);
    W = (uint8_t *) (l1_buffer + 6816);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 20, 20, 1, 20, 1, 0, 0, 0, 0, 0, 0, 8);
