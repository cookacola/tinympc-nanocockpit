...
#include "mem.h"
#include <string.h>
#include "stdc_encoder_BNReluConvolution0.h"
#include "stdc_encoder_BNReluConvolution13.h"
#include "stdc_encoder_ReluQAddition15.h"
#include "stdc_encoder_BNReluConvolution1.h"
#include "stdc_encoder_BNReluConvolution3.h"
#include "stdc_encoder_BNReluConvolution6.h"
#include "stdc_encoder_ReluQAddition21.h"
#include "stdc_encoder_BNReluConvolution9.h"
#include "stdc_encoder_ReluQAddition10.h"
#include "stdc_encoder_BNReluConvolution20.h"
#include "stdc_encoder_ReluQAddition7.h"
#include "stdc_encoder_BNReluConvolution17.h"
#include "stdc_encoder_BNReluConvolution11.h"
#include "stdc_encoder_ReluQAddition18.h"
#include "stdc_encoder_BNReluConvolution5.h"
#include "stdc_encoder_BNReluConvolution2.h"
#include "stdc_encoder_BNReluConvolution12.h"
#include "stdc_encoder_BNReluConvolution14.h"
#include "stdc_encoder_BNReluConvolution8.h"
#include "stdc_encoder_BNReluConvolution19.h"
#include "stdc_encoder_BNReluConvolution4.h"
#include "stdc_encoder_BNReluConvolution16.h"
...
int stdc_encoder_cycle_network_execution;
...
void stdc_encoder_execute_layer_fork(void *args) {
  ...
  {
    case 0:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution0, args);
      break;
    case 1:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution1, args);
      break;
    case 2:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution2, args);
      break;
    case 3:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution3, args);
      break;
    case 4:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution4, args);
      break;
    case 5:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution5, args);
      break;
    case 6:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution6, args);
      break;
    case 7:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_ReluQAddition7, args);
      break;
    case 8:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution8, args);
      break;
    case 9:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution9, args);
      break;
    case 10:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_ReluQAddition10, args);
      break;
    case 11:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution11, args);
      break;
    case 12:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution12, args);
      break;
    case 13:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution13, args);
      break;
    case 14:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution14, args);
      break;
    case 15:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_ReluQAddition15, args);
      break;
    case 16:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution16, args);
      break;
    case 17:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution17, args);
      break;
    case 18:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_ReluQAddition18, args);
      break;
    case 19:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution19, args);
      break;
    case 20:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_BNReluConvolution20, args);
      break;
    case 21:
      pi_cl_team_fork(NUM_CORES, (void *)stdc_encoder_ReluQAddition21, args);
      break;
  }
...
struct stdc_encoder_network_run_token stdc_encoder_network_run_async(void *l2_buffer, size_t l2_buffer_size, void *l2_final_output, int exec, int initial_dir)
{
  ...
  // open cluster...
  pi_cluster_task(&cluster_task, stdc_encoder_network_run_cluster, args);
  ...
  return (struct stdc_encoder_network_run_token) {
...
void stdc_encoder_network_run_wait(struct stdc_encoder_network_run_token token)
{
  ...
  print_perf("Final", stdc_encoder_cycle_network_execution, 16192000);
}

void stdc_encoder_network_run(void *l2_buffer, size_t l2_buffer_size, void *l2_final_output, int exec, int initial_dir)
{
  stdc_encoder_network_run_wait(stdc_encoder_network_run_async(l2_buffer, l2_buffer_size, l2_final_output, exec, initial_dir));
}
...
static struct pi_cluster_task stdc_encoder_cluster_task_async;
static unsigned int stdc_encoder_args_async[5];
...
{
  stdc_encoder_args_async[0] = (unsigned int) l2_buffer;
  stdc_encoder_args_async[1] = (unsigned int) l2_buffer_size;
  stdc_encoder_args_async[2] = (unsigned int) l2_final_output;
  stdc_encoder_args_async[3] = (unsigned int) exec;
  stdc_encoder_args_async[4] = (unsigned int) initial_dir;
  pi_cluster_task(&stdc_encoder_cluster_task_async, stdc_encoder_network_run_cluster, stdc_encoder_args_async);
  stdc_encoder_cluster_task_async.stack_size = 3500;
  stdc_encoder_cluster_task_async.slave_stack_size = 3400;
  pi_cluster_send_task_to_cl_async(cluster, &stdc_encoder_cluster_task_async, network_done);
}
...
/* ---------------------------------- */
  ...
  stdc_encoder_cycle_network_execution = 0;
/* MAIN SECTION
...
*/
    ...
    pi_perf_stop();
    pi_perf_start();
    stdc_encoder_execute_layer_fork((void *) &largs);
    // performance measurements: end
    pi_perf_stop();
    perf_cyc =  pi_perf_read(PI_PERF_CYCLES);
    stdc_encoder_cycle_network_execution += perf_cyc;
  ...
  //memcpy(L2_output, l2_final_output, activations_out_size[21]); // BUGGY!
  for (int i=0; i<activations_out_size[21]; i++)
