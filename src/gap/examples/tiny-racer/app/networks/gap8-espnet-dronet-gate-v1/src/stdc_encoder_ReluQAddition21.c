...
// ULTRA_VERBOSE                  False
// verbose_log
// node                           <dory.Parsers.HW_node.HW_node object at 0x740b6b1dfdc0>
// sdk                            gap_sdk
// number_of_clusters             1
// optional_type                  8bit
// func_name                      stdc_encoder_ReluQAddition21
// flag_DW                        0
...
void stdc_encoder_ReluQAddition21(
  void *args
) {
  ...
  for(iter=0; iter<1*3*1; iter++) {
    ...
    DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 9, 20, 64, 20, 64,  0, 0,0, 0, 0, 0, 8);
    ...
    DMA_copy_x2.ext = dory_get_tile_3d(l2_x2, _i_h_load, _i_w_load, _i_nif_load, 9, 20, 64, 20, 64,  0, 0,0, 0, 0, 0, 8);
    ...
    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 9, 20, 64, 20, 64, 0, 0, 0, 0, 0, 0, 8);
