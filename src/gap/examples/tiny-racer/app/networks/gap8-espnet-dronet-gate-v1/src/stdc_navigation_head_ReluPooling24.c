...
// ULTRA_VERBOSE                  False
// verbose_log
// node                           <dory.Parsers.HW_node.HW_node object at 0x7a901a4ef190>
// sdk                            gap_sdk
// number_of_clusters             1
// optional_type                  8bit
// func_name                      stdc_navigation_head_ReluPooling24
// flag_DW                        0
...
// x_tile_size_h                  10
// x_tile_size_w                  10
// x_tile_size_byte               200
// x_tile_size_nif_byte           2
// x_stride_w_byte                20
// x_stride_c_byte                2
// y_h                            1
// y_w                            1
...
void stdc_navigation_head_ReluPooling24(
  void *args
) {
 ...
 uint8_t *im2col;
  ...
  for(iter=0; iter<1*1*1; iter++) {
    ...
    DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 10, 10, 2, 10, 2,  0, 0,0, pad_offset_h, pad_offset_w, 0, 8);
    ...
    y = (uint8_t *) (l1_buffer + 208);


    y_tile_size_nof = (last_nof) ? 2 : 2;
    y_tile_size_h   = (last_h)   ? 1 : 1;
    y_tile_size_w   = (last_w)   ? 1 : 1;
    y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*8/8;
    y_length_nof_byte = (last_nof)   ? 2 : 2;
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
...
// aggiungere padding su tutti i lati, acc_out, and filter asymettric
    ...
    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 1, 1, 2, 1, 2, 0, 0, 0, 0, 0, 0, 8);
    DMA_copy_y.loc = (l1_buffer + 208);
