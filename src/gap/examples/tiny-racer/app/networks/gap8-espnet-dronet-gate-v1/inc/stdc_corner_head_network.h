...
static const char * L3_weights_files[] = {
  "stdc_corner_head_BNReluConvolution0_weights.hex", "stdc_corner_head_BNReluConvolution1_weights.hex", "stdc_corner_head_BNReluConvolution2_weights.hex", "stdc_corner_head_BNReluConvolution3_weights.hex"
};
static int L3_weights_size[4];
static int layers_pointers[4];
static char * Layers_name[4] = {"stdc_corner_head_BNReluConvolution0", "stdc_corner_head_BNReluConvolution1", "stdc_corner_head_BNReluConvolution2", "stdc_corner_head_BNReluConvolution3"};
...
static int weights_checksum[4] = {201, 233, 184, 240};
static int weights_size[4] = {2560, 800, 768, 128};
...
static int out_shift_vector[4] = {22, 22, 22, 24};
...
static int activations_out_size[4] = {12800, 12800, 6400, 1600};
