...
void stdc_corner_head_network_run_wait(struct stdc_corner_head_network_run_token token)
{
  ...
  print_perf("Final", stdc_corner_head_cycle_network_execution, 1036800);
}
...
*/
  ...
  //memcpy(L2_output, l2_final_output, activations_out_size[2]); // BUGGY!
  for (int i=0; i<activations_out_size[2]; i++)
