...
void stdc_encoder_BNReluConvolution1(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 5)   ? 13 : 14;
      ...
      if(_i_w_load > 0)
        pad_offset_w = 1;
      y_tile_size_h   = (_i_h_load+1 == 5)   ? 12 : 12;
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.ext = (uint32_t) l2_W+144 + 64*_i_nof_load;
        ...
        DMA_copy_lambda.ext = (uint32_t) l2_W+208 + 64*_i_nof_load;
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 33520;
    ...
    k = (int32_t *) (l1_buffer + 33448);
    lambda = (int32_t *) (l1_buffer + 33520);
