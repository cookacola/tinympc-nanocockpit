...
void stdc_encoder_BNReluConvolution4(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 24, 30, 16, 40, 16,  0, 0,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 32, 1*1, 16, 1*1, 16, 0,0,0,0,0,0, 8);
        ...
        DMA_copy_k.ext = (uint32_t) l2_W+512 + 128*_i_nof_load;
        ...
        DMA_copy_lambda.ext = (uint32_t) l2_W+640 + 128*_i_nof_load;
    ...
    lambda = (int32_t *) (l1_buffer + 35232);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 24, 30, 32, 40, 32, 0, 0, 0, 0, 0, 0, 8);
