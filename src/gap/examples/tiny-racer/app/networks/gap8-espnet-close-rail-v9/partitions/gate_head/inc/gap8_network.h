...
static int weights_checksum[7] = {70, 174, 204, 33, 10, 0, 16};
static int weights_size[7] = {18688, 55680, 83328, 83328, 83328, 0, 600};
...
static int out_mult_vector[7] = {51, 32, 58, 61, 52, 4100, 44};
static int out_shift_vector[7] = {15, 13, 13, 13, 13, 12, 11};
...
static int activations_out_size[7] = {25600, 9600, 9600, 9600, 9600, 96, 6};
