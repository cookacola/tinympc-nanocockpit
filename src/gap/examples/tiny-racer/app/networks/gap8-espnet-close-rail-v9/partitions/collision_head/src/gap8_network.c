...
#include "gap8_ReluPooling5.h"
#include "gap8_ReluConvolution0.h"
...
void gap8_execute_layer_fork(void *args) {
  ...
  {
    case 0:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_ReluConvolution0, args);
      break;
    case 1:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_ReluConvolution1, args);
      break;
    case 2:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_ReluConvolution2, args);
      break;
    case 3:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_ReluConvolution3, args);
      break;
    case 4:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_ReluConvolution4, args);
      break;
    case 5:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_ReluPooling5, args);
      break;
    case 6:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_ReluConvolution6, args);
      break;
  }
...
void gap8_network_run_wait(struct gap8_network_run_token token)
{
  ...
  print_perf("Final", gap8_cycle_network_execution, 37785888);
}
