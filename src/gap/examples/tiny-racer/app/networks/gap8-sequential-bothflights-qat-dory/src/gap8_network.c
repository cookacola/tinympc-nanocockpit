...
#include "gap8_BNReluConvolution7.h"
...
#include "gap8_BNReluConvolution23.h"
#include "gap8_BNReluConvolution4.h"
#include "gap8_BNReluConvolution2.h"
#include "gap8_BNReluConvolution20.h"
...
#include "gap8_BNReluConvolution14.h"
...
void gap8_execute_layer_fork(void *args) {
  ...
  switch (layer_args->layer_id)
  {
    ...
    case 6:
      ...
      break;
    case 7:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_BNReluConvolution7, args);
      break;
    case 8:
    ...
    case 10:
      ...
      break;
    case 11:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_BNReluConvolution11, args);
      break;
    case 12:
    ...
    case 13:
      ...
      break;
    case 14:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_BNReluConvolution14, args);
      break;
    case 15:
    ...
    case 16:
      ...
      break;
    case 17:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_BNReluConvolution17, args);
      break;
    case 18:
    ...
    case 19:
      ...
      break;
    case 20:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_BNReluConvolution20, args);
      break;
    case 21:
    ...
    case 22:
      ...
      break;
    case 23:
      pi_cl_team_fork(NUM_CORES, (void *)gap8_BNReluConvolution23, args);
      break;
  }
...
void gap8_network_run_wait(struct gap8_network_run_token token)
{
  ...
  print_perf("Final", gap8_cycle_network_execution, 28152000);
}
...
*/
  ...
  //memcpy(L2_output, l2_final_output, activations_out_size[23]); // BUGGY!
  for (int i=0; i<activations_out_size[23]; i++)
