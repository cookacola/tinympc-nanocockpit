...
void stdc_encoder_BNReluConvolution0(
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 2)   ? 57 : 65;
      x_tile_size_w   = (_i_w_load+1 == 2)   ? 49 : 113;
      ...
      if(_i_w_load > 0)
        pad_offset_w = 1;
      y_tile_size_h   = (_i_h_load+1 == 2)   ? 28 : 32;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 65, 113, 1, 160, 1,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.loc = (uint32_t) l1_buffer + 36185;
        ...
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 36257;
    ...
    k = (int32_t *) (l1_buffer + 36185);
    lambda = (int32_t *) (l1_buffer + 36257);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 32, 56, 16, 80, 16, 0, 0, 0, 0, 0, 0, 8);
