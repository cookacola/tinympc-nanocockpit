  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.ext = (uint32_t) l2_W+3072 + 256*_i_nof_load;
        ...
        DMA_copy_lambda.ext = (uint32_t) l2_W+3328 + 256*_i_nof_load;
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 21280;
    ...
    k = (int32_t *) (l1_buffer + 21016);
    lambda = (int32_t *) (l1_buffer + 21280);
