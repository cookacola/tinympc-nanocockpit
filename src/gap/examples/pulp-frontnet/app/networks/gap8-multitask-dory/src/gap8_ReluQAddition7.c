...
// ULTRA_VERBOSE                  False
// verbose_log                    
// node                           <dory.Parsers.HW_node.HW_node object at 0x7d6ef81498a0>
// sdk                            gap_sdk
// number_of_clusters             1
// optional_type                  8bit
// func_name                      gap8_ReluQAddition7
// flag_DW                        0
...
// x_tile_size_h                  15
// x_tile_size_w                  40
// x_tile_size_byte               12000
// x_tile_size_nif_byte           20
// x_stride_w_byte                800
// x_stride_c_byte                20
// y_h                            40
// y_w                            40
...
// y_tile_size_h                  15
// y_tile_size_w                  40
// y_tile_size_byte               12000
// y_stride_w_byte                800
// y_stride_c_byte                20
// y_tile_size_nof_byte           20
// tile_dim_h                     3
// tile_dim_w                     1
// tile_dim_nof                   1
// tile_dim_nif                   1
...
// y_length_nof_byte_last         20
// x_tile_size_nif_last           20
// x_tile_size_nif_byte_last      20
...
void gap8_ReluQAddition7(
  ...
  DMA_copy_x2.stride_2d = 800;
  DMA_copy_x2.stride_1d = 20;
  DMA_copy_x2.dir = 1;
  ...
  for(iter=0; iter<1*3*1; iter++) {
    ...
    x_tile_size_nif = (last_nif) ? 20 : 20;
    x_tile_size_h   = (last_h)   ? 10 : 15;
    x_tile_size_w   = (last_w)   ? 40 : 40;
    x_tile_size_byte = x_tile_size_nif*x_tile_size_h*x_tile_size_w*8/8;
    x_length_nif_byte = (last_nif)   ? 20 : 20;
    // additionally overlap by padding for the first tile after a border one
    //this because in the first tile we use less pixels from x_buffer, since we have the ones of padding

    DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 15, 40, 20, 40, 20,  0, 0,0, 0, 0, 0, 8);
    ...
    DMA_copy_x2.ext = dory_get_tile_3d(l2_x2, _i_h_load, _i_w_load, _i_nif_load, 15, 40, 20, 40, 20,  0, 0,0, 0, 0, 0, 8);
    DMA_copy_x2.loc = (l1_buffer + 24016);
    ...
    y_tile_size_h   = (last_h)   ? 10 : 15;
    y_tile_size_w   = (last_w)   ? 40 : 40;

    x = (uint8_t *) (l1_buffer + 0);
    x2 = (uint8_t *) (l1_buffer + 24016);
    y = (uint8_t *) (l1_buffer + 12008);

    y_tile_size_nof = (last_nof) ? 20 : 20;
    y_tile_size_h   = (last_h)   ? 10 : 15;
    y_tile_size_w   = (last_w)   ? 40 : 40;
    y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*8/8;
    y_length_nof_byte = (last_nof)   ? 20 : 20;
    asm volatile("": : :"memory");
    ...
    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 15, 40, 20, 40, 20, 0, 0, 0, 0, 0, 0, 8);
    DMA_copy_y.loc = (l1_buffer + 12008);
