  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.loc = (uint32_t) l1_buffer + 32096;
        ...
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 32136;
    ...
    k = (int32_t *) (l1_buffer + 32096);
    lambda = (int32_t *) (l1_buffer + 32136);
