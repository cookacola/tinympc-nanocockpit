...
// ULTRA_VERBOSE                  False
// verbose_log                    
// node                           <dory.Parsers.HW_node.HW_node object at 0x7d6ef814bac0>
// sdk                            gap_sdk
// number_of_clusters             1
// optional_type                  8bit
// func_name                      gap8_ReluQAddition20
// flag_DW                        0
...
void gap8_ReluQAddition20(
  ...
  for(iter=0; iter<1*3*1; iter++) {
    ...
    x_tile_size_h   = (last_h)   ? 2 : 19;
    x_tile_size_w   = (last_w)   ? 40 : 40;
    x_tile_size_byte = x_tile_size_nif*x_tile_size_h*x_tile_size_w*8/8;
    x_length_nif_byte = (last_nif)   ? 16 : 16;
    // additionally overlap by padding for the first tile after a border one
    //this because in the first tile we use less pixels from x_buffer, since we have the ones of padding

    DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 19, 40, 16, 40, 16,  0, 0,0, 0, 0, 0, 8);
    ...
    DMA_copy_x2.ext = dory_get_tile_3d(l2_x2, _i_h_load, _i_w_load, _i_nif_load, 19, 40, 16, 40, 16,  0, 0,0, 0, 0, 0, 8);
    ...
    y_length_nof_byte = (last_nof)   ? 16 : 16;
    asm volatile("": : :"memory");
    ...
    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 19, 40, 16, 40, 16, 0, 0, 0, 0, 0, 0, 8);
