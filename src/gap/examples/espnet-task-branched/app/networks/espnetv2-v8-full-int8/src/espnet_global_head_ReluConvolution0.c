...
void espnet_global_head_ReluConvolution0(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 31816);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 3)   ? 9 : 17;
      x_tile_size_w   = (_i_w_load+1 == 3)   ? 9 : 17;
      ...
      y_tile_size_w   = (_i_w_load+1 == 3)   ? 4 : 8;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 17, 17, 32, 40, 32,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 13360);
    ...
    b = (uint8_t *) (l1_buffer + 31816 + _i_nof_load*256);
    W = (uint8_t *) (l1_buffer + 13360);
    y = (uint8_t *) (l1_buffer + 9256);
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 8, 8, 64, 20, 64, 0, 0, 0, 0, 0, 0, 8);
      DMA_copy_y.loc = (l1_buffer + 9256);
