...
void espnet_global_head_ReluConvolution3(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+82944;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 21448);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 2)   ? 4 : 9;
      x_tile_size_w   = (_i_w_load+1 == 2)   ? 5 : 8;
      ...
      if(_i_w_load > 0)
        pad_offset_w = 1;
      y_tile_size_h   = (_i_h_load+1 == 2)   ? 3 : 7;
      y_tile_size_w   = (_i_w_load+1 == 2)   ? 4 : 6;
      y_tile_size_nof = (_i_nof_load+1 == 6) ? 16 : 16;
      y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*8/8;
      y_length_nof_byte = (_i_nof_load+1 == 6)   ? 16 : 16;
      W_tile_size_nof = (_i_nof_load+1 == 6) ? 16 : 16;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 9, 8, 96, 10, 96,  2, 2,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 16, 3*3, 96, 3*3, 96, 0,0,0,0,0,0, 8);
        DMA_copy_W.loc = (l1_buffer + 7600);
    ...
    b = (uint8_t *) (l1_buffer + 21448 + _i_nof_load*64);
    W = (uint8_t *) (l1_buffer + 7600);
    y = (uint8_t *) (l1_buffer + 6920);
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 7, 6, 16, 10, 96, 0, 0, 0, 0, 0, 0, 8);
      DMA_copy_y.loc = (l1_buffer + 6920);
