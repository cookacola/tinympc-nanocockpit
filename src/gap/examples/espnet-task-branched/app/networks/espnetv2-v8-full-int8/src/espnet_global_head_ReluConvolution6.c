...
void espnet_global_head_ReluConvolution6(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  DMA_copy_y.stride_2d = 3;
  DMA_copy_y.stride_1d = 3;
  DMA_copy_y.dir = 0;
  ...
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+288;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 427);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      y_length_nof_byte = (_i_nof_load+1 == 1)   ? 3 : 3;
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 3, 1*1, 96, 1*1, 96, 0,0,0,0,0,0, 8);
        DMA_copy_W.loc = (l1_buffer + 115);
    ...
    b = (uint8_t *) (l1_buffer + 427 + _i_nof_load*12);
    W = (uint8_t *) (l1_buffer + 115);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 1, 1, 3, 1, 3, 0, 0, 0, 0, 0, 0, 8);
