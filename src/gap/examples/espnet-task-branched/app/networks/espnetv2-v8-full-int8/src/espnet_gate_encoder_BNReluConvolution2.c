...
void espnet_gate_encoder_BNReluConvolution2(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_k.ext = (uint32_t) l2_W+256 + 128*_i_nof_load;
        ...
        DMA_copy_lambda.ext = (uint32_t) l2_W+384 + 128*_i_nof_load;
        DMA_copy_lambda.loc = (uint32_t) l1_buffer + 36256;
    ...
    k = (int64_t *) (l1_buffer + 36120);
    lambda = (int64_t *) (l1_buffer + 36256);
