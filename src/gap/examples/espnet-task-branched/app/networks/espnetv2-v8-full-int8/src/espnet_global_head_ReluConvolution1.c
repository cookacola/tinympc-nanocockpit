...
void espnet_global_head_ReluConvolution1(
  void *args
) {
  //////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+55296;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 26792);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 2)   ? 5 : 17;
      x_tile_size_w   = (_i_w_load+1 == 5)   ? 5 : 5;
      ...
      y_tile_size_w   = (_i_w_load+1 == 5)   ? 2 : 2;
      y_tile_size_nof = (_i_nof_load+1 == 3) ? 24 : 36;
      y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*8/8;
      y_length_nof_byte = (_i_nof_load+1 == 3)   ? 24 : 36;
      W_tile_size_nof = (_i_nof_load+1 == 3) ? 24 : 36;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 17, 5, 64, 20, 64,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
    ...
    b = (uint8_t *) (l1_buffer + 26792 + _i_nof_load*144);
    W = (uint8_t *) (l1_buffer + 6032);
    y = (uint8_t *) (l1_buffer + 5448);
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 8, 2, 36, 10, 96, 0, 0, 0, 0, 0, 0, 8);
      DMA_copy_y.loc = (l1_buffer + 5448);
