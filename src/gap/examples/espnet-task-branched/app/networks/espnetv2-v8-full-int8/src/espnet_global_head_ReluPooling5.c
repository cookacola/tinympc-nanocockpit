...
// ULTRA_VERBOSE                  False
// verbose_log
// node                           <dory.Parsers.HW_node.HW_node object at 0x71adea8fd720>
// sdk                            gap_sdk
// number_of_clusters             1
// optional_type                  8bit
// func_name                      espnet_global_head_ReluPooling5
// flag_DW                        0
...
void espnet_global_head_ReluPooling5(
  void *args
) {
...
// aggiungere padding su tutti i lati, acc_out, and filter asymettric
    ...
    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 1, 1, 96, 1, 96, 0, 0, 0, 0, 0, 0, 8);
