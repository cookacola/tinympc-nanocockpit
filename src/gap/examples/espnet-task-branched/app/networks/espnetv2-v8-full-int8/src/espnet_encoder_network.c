...
#include "mem.h"
#include <string.h>
#include "espnet_encoder_BNReluConvolution3.h"
#include "espnet_encoder_BNReluConvolution2.h"
#include "espnet_encoder_BNReluConvolution0.h"
#include "espnet_encoder_ReluQAddition10.h"
#include "espnet_encoder_ReluQAddition7.h"
#include "espnet_encoder_BNReluConvolution5.h"
#include "espnet_encoder_BNReluConvolution8.h"
#include "espnet_encoder_BNReluConvolution9.h"
#include "espnet_encoder_BNReluConvolution4.h"
#include "espnet_encoder_BNReluConvolution6.h"
#include "espnet_encoder_BNReluConvolution1.h"
...
int espnet_encoder_cycle_network_execution;
/* Moves the weights and the biases from hyperflash to hyperram */
void espnet_encoder_network_initialize() {
...
void espnet_encoder_execute_layer_fork(void *args) {
  ...
  {
    case 0:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution0, args);
      break;
    case 1:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution1, args);
      break;
    case 2:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution2, args);
      break;
    case 3:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution3, args);
      break;
    case 4:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution4, args);
      break;
    case 5:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution5, args);
      break;
    case 6:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution6, args);
      break;
    case 7:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_ReluQAddition7, args);
      break;
    case 8:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution8, args);
      break;
    case 9:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_BNReluConvolution9, args);
      break;
    case 10:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_encoder_ReluQAddition10, args);
      break;
  }
...
struct espnet_encoder_network_run_token espnet_encoder_network_run_async(void *l2_buffer, size_t l2_buffer_size, void *l2_final_output, int exec, int initial_dir)
{
  ...
  // open cluster...
  pi_cluster_task(&cluster_task, espnet_encoder_network_run_cluster, args);
  ...
  return (struct espnet_encoder_network_run_token) {
    .cluster_dev = cluster_dev
  };
}

void espnet_encoder_network_run_wait(struct espnet_encoder_network_run_token token)
{
  pi_cluster_close(&token.cluster_dev);
  print_perf("Final", espnet_encoder_cycle_network_execution, 10572800);
}

void espnet_encoder_network_run(void *l2_buffer, size_t l2_buffer_size, void *l2_final_output, int exec, int initial_dir)
{
  espnet_encoder_network_run_wait(espnet_encoder_network_run_async(l2_buffer, l2_buffer_size, l2_final_output, exec, initial_dir));
}
...
static struct pi_cluster_task espnet_encoder_cluster_task_async;
static unsigned int espnet_encoder_args_async[5];
void espnet_encoder_network_run_async_cl(void *l2_buffer, size_t l2_buffer_size, void *l2_final_output, int exec, int initial_dir, pi_device_t *cluster, pi_task_t *network_done)
{
  espnet_encoder_args_async[0] = (unsigned int) l2_buffer;
  espnet_encoder_args_async[1] = (unsigned int) l2_buffer_size;
  espnet_encoder_args_async[2] = (unsigned int) l2_final_output;
  espnet_encoder_args_async[3] = (unsigned int) exec;
  espnet_encoder_args_async[4] = (unsigned int) initial_dir;
  pi_cluster_task(&espnet_encoder_cluster_task_async, espnet_encoder_network_run_cluster, espnet_encoder_args_async);
  espnet_encoder_cluster_task_async.stack_size = 3500;
  espnet_encoder_cluster_task_async.slave_stack_size = 3400;
  pi_cluster_send_task_to_cl_async(cluster, &espnet_encoder_cluster_task_async, network_done);
}

void espnet_encoder_network_run_cluster(void *args) {
...
/* ---------------------------------- */
  ...
  espnet_encoder_cycle_network_execution = 0;
/* MAIN SECTION
...
*/
    ...
    pi_perf_stop();
    pi_perf_start();
    espnet_encoder_execute_layer_fork((void *) &largs);
    // performance measurements: end
    pi_perf_stop();
    perf_cyc =  pi_perf_read(PI_PERF_CYCLES);
    espnet_encoder_cycle_network_execution += perf_cyc;
