...
#include "mem.h"
#include <string.h>
#include "espnet_global_head_ReluConvolution4.h"
#include "espnet_global_head_ReluConvolution3.h"
#include "espnet_global_head_ReluConvolution1.h"
#include "espnet_global_head_ReluPooling5.h"
#include "espnet_global_head_ReluConvolution0.h"
#include "espnet_global_head_ReluConvolution2.h"
#include "espnet_global_head_ReluConvolution6.h"
...
int espnet_global_head_cycle_network_execution;
...
void espnet_global_head_execute_layer_fork(void *args) {
  ...
  {
    case 0:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_global_head_ReluConvolution0, args);
      break;
    case 1:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_global_head_ReluConvolution1, args);
      break;
    case 2:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_global_head_ReluConvolution2, args);
      break;
    case 3:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_global_head_ReluConvolution3, args);
      break;
    case 4:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_global_head_ReluConvolution4, args);
      break;
    case 5:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_global_head_ReluPooling5, args);
      break;
    case 6:
      pi_cl_team_fork(NUM_CORES, (void *)espnet_global_head_ReluConvolution6, args);
      break;
  }
...
struct espnet_global_head_network_run_token espnet_global_head_network_run_async(void *l2_buffer, size_t l2_buffer_size, void *l2_final_output, int exec, int initial_dir)
{
  ...
  // open cluster...
  pi_cluster_task(&cluster_task, espnet_global_head_network_run_cluster, args);
  ...
  return (struct espnet_global_head_network_run_token) {
...
void espnet_global_head_network_run_wait(struct espnet_global_head_network_run_token token)
{
  ...
  print_perf("Final", espnet_global_head_cycle_network_execution, 37785888);
}

void espnet_global_head_network_run(void *l2_buffer, size_t l2_buffer_size, void *l2_final_output, int exec, int initial_dir)
{
  espnet_global_head_network_run_wait(espnet_global_head_network_run_async(l2_buffer, l2_buffer_size, l2_final_output, exec, initial_dir));
}
...
static struct pi_cluster_task espnet_global_head_cluster_task_async;
static unsigned int espnet_global_head_args_async[5];
...
{
  espnet_global_head_args_async[0] = (unsigned int) l2_buffer;
  espnet_global_head_args_async[1] = (unsigned int) l2_buffer_size;
  espnet_global_head_args_async[2] = (unsigned int) l2_final_output;
  espnet_global_head_args_async[3] = (unsigned int) exec;
  espnet_global_head_args_async[4] = (unsigned int) initial_dir;
  pi_cluster_task(&espnet_global_head_cluster_task_async, espnet_global_head_network_run_cluster, espnet_global_head_args_async);
  espnet_global_head_cluster_task_async.stack_size = 3500;
  espnet_global_head_cluster_task_async.slave_stack_size = 3400;
  pi_cluster_send_task_to_cl_async(cluster, &espnet_global_head_cluster_task_async, network_done);
}
...
/* ---------------------------------- */
  ...
  espnet_global_head_cycle_network_execution = 0;
/* MAIN SECTION
...
*/
    ...
    pi_perf_stop();
    pi_perf_start();
    espnet_global_head_execute_layer_fork((void *) &largs);
    // performance measurements: end
    pi_perf_stop();
    perf_cyc =  pi_perf_read(PI_PERF_CYCLES);
    espnet_global_head_cycle_network_execution += perf_cyc;
