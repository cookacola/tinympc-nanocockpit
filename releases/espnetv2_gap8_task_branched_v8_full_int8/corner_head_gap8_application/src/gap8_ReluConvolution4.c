...
void gap8_ReluConvolution4(
  ...
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+256;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 27496);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 4, 1*1, 64, 1*1, 64, 0,0,0,0,0,0, 8);
    ...
    b = (uint8_t *) (l1_buffer + 27496 + _i_nof_load*16);
