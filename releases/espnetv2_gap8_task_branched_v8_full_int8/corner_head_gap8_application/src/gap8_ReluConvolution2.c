...
void gap8_ReluConvolution2(
  ...
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 26280);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 3)   ? 5 : 10;
      x_tile_size_w   = (_i_w_load+1 == 10)   ? 3 : 4;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 10, 4, 64, 20, 64,  2, 2,0, pad_offset_h, pad_offset_w, 0, 8);
    ...
    b = (uint8_t *) (l1_buffer + 26280 + _i_nof_load*160);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 8, 2, 40, 20, 64, 0, 0, 0, 0, 0, 0, 8);
